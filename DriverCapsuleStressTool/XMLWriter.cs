...
namespace DriverCapsuleStressTool
{
    class XMLWriter
    {
        ...
        /// <param name="InputTestFilePathBAK"></param>
        /// <param name="infName"></param>
        internal static void SetInstallCount(string InputTestFilePathBAK, string line)
        {
            try
            {
                Logger.FunctionEnter();
                ...
                foreach (var driverPath in driversPathList.Elements())
                {
                    ...
                    if (line.Contains(DriverInfPath))
                    {
        ...
        /// <param name="InputTestFilePathBAK"></param>
        /// <param name="infName"></param>
        internal static void SetUnInstallCount(string InputTestFilePathBAK, string line)
        {
            try
            {
                Logger.FunctionEnter();
                ...
                foreach (var driverPath in driversPathList.Elements())
                {
                    ...
                    if (line.Contains(DriverInfPath))
                    {
                        ...
                        driverPath.Attribute("InstallCount").Value = currentUnInstallCount.ToString();
                        testInputData.Save(InputTestFilePathBAK);
                        Thread.Sleep(2000);
                    }
                }
