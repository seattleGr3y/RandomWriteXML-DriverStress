...
namespace DriverCapsuleStressTool
{
    class SafeNativeMethods
    {
        ...
        internal static void Install_Inf(string line, string installer, string installArgs)
        {
        ...
        internal static void InstallUninstallCall(int seedIndex, bool rebootRequired, string infName, string line, string installer, string InputTestFilePath, string hardwareID)
        {
            try
            {
                ...
                if (isInstalled)
                {
                    ...
                    XMLWriter.SetUnInstallCount(Program.InputTestFilePathBAK, line);
                    Thread.Sleep(1000);
                ...
                else
                {
                    ...
                    XMLWriter.SetInstallCount(Program.InputTestFilePathBAK, line);
                    Thread.Sleep(1000);
                    Logger.Comment("rebootRequired is showing as : " + rebootRequired);
        ...
        internal static void RollbackInstall(int seedIndex, string line, string infName, string infFileContent, string hardwareID, bool rebootRequired, string InputTestFilePath)
        {
            ...
            try
            {
                ...
                installArgs = " /C /U " + line + " /Q /D";
                Install_Inf(line, Program.installer, installArgs);
